...
// we use store.subscribe to keep track of changes
store.subscribe(() => {
...
const expenseOne = store.dispatch(addExpense({ description: 'Rent', amount: 150000, createdAt: -1111000 }));
